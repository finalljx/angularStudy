...
.controller('LoginCtrl', ['$scope','$http','$state', function($scope,$http,$state){
  ...
  $scope.login=function(){
    ...
    $http({method: 'GET', url: 'https://box.vgolive.com/api/login', headers: {
    'X-Auth-User': 'demouser01',"X-Auth-Key":"96e79218965eb72c92a549dd5a330112","Access-Control-Allow-Origin":" *"}
